...
@property (readwrite) BOOL showOnePaymentView;
...
- (void) didFinishLoginSignalAndReloadRemoteConfig:(id) sender
                                    enableDelegate:(BOOL) enableDelegate;
...
- (BOOL)isDisableWelcomeText;

- (void)setDisableWelcomeText:(BOOL)newValue;
